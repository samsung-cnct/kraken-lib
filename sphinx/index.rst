...
.. jsonschema:: ../schemas/config/v1/canalFabricNetwork.json
.. jsonschema:: ../schemas/config/v1/canalFabricNetworkVxlan.json
.. jsonschema:: ../schemas/config/v1/canalFabricOptions.json
.. jsonschema:: ../schemas/config/v1/cluster.json
.. jsonschema:: ../schemas/config/v1/config.json
.. jsonschema:: ../schemas/config/v1/containerConfig.json
.. jsonschema:: ../schemas/config/v1/coreOsConfig.json
.. jsonschema:: ../schemas/config/v1/coreOsLocksmithConfig.json
.. jsonschema:: ../schemas/config/v1/definitions.json
.. jsonschema:: ../schemas/config/v1/deployment.json
.. jsonschema:: ../schemas/config/v1/dnsConfig.json
.. jsonschema:: ../schemas/config/v1/dockerContainerConfig.json
.. jsonschema:: ../schemas/config/v1/etcdConfig.json
.. jsonschema:: ../schemas/config/v1/fabricConfig.json
.. jsonschema:: ../schemas/config/v1/gkeKeyPairConfig.json
.. jsonschema:: ../schemas/config/v1/gkeNodeConfig.json
.. jsonschema:: ../schemas/config/v1/gkeNodeProviderConfig.json
.. jsonschema:: ../schemas/config/v1/gkeProviderConfig.json
