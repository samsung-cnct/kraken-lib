...
inf "`n`nParameters for ansible:`n   --inventory-file $krakenRoot\bin\clusters\$clustername\ansible.inventory`n   `
  --private-key $krakenRoot\bin\clusters\$clustername\id_rsa"
